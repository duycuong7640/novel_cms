...
buildmobilemenu: function($, setting, $ul){
	...
	if (!this.mobilecontainer.$main){ // if primary mobile menu container not defined yet
		var $maincontainer = $('<div class="ddsmoothmobile"><div class="topulsdiv"><a class="logo_mobile" href="'+link_logo_mobile+'"><img src="'+logo_mobile+'"/></a></div></div>').appendTo(document.body)
		/*$maincontainer
