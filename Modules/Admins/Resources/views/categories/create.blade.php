                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{--                                <textarea name="content" placeholder="Mô tả" rows="4"--}}
                            {{--                                          class="form-control ckeditor"></textarea>--}}
                            {{--                            </div>--}}
                            <div class="form-group">
                                <label>Vị trí</label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control col-md-3">
                                    ...
                                    @foreach(dataCategory::TYPE as $k=>$row)
                                        <option value="{{ $row }}">{{ dataCategory::TYPE_NAME[$row] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Icon Fontawesome --> <a target="_blank" href="https://fontawesome.com/v6/search">Link</a></label>
                                <input type="text" name="fontawesome_icon" class="form-control" placeholder="{{ '<i class="fa-solid fa-house"></i>' }}"/>
                            </div>
                            {{--                            <div class="form-group">--}}
