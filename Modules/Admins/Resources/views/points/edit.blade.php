                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-9 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Point</label>
                                <input type="number" name="point" value="{{ $data['detail']->point }}" class="form-control" placeholder=""/>
                            </div>
                            <div class="form-group">
                                <label>Amount</label>
                                <input type="number" name="amount" value="{{ $data['detail']->amount }}" class="form-control" placeholder=""/>
                            </div>
                            <div class="form-group">
