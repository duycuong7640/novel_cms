                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($data['list'] as $k=>$row)
                                    <tr>
                                        ...
                                        {{--                                        <td>--}}
                                        {{--                                            <a class="icon-form status active"--}}
                                        {{--                                               href="{{ route('admin.post.status', ['id' => $row->id, 'field' => 'choose_3']) }}">--}}
                                        ...
                                        <td>
                                            <a class="icon-form" title="edit"
                                               href="{{ route('admin.post.edit', ['id' => $row->id, 'page' => $data['list']->currentPage(), 'parent_id' => (request()->has('parent_id') ? request()->get('parent_id') : '')]) }}">
                                                <i class="icon-note"></i>
                                            </a>
                                            <a class="icon-form status active"
                                            ...
                                            <a class="icon-form"
                                               href="javascript:confirmDelete('{{ route('admin.post.destroy', ['id' => $row->id]) }}', '{{ adminNotify::CONFIRM_DELETE }}')">
