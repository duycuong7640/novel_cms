                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($data['list'] as $k=>$row)
                                    <tr>
                                        ...
                                        {{--                                        <td>--}}
                                        {{--                                            <a class="icon-form status active"--}}
                                        {{--                                               href="{{ route('admin.product.status', ['id' => $row->id, 'field' => 'choose_3']) }}">--}}
                                        ...
                                        <td>
                                            ...
                                            <a class="icon-form"
                                               href="javascript:confirmDelete('{{ route('admin.product.destroy', ['id' => $row->id]) }}', '{{ adminNotify::CONFIRM_DELETE }}')">
