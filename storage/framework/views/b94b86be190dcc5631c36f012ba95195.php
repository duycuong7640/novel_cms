                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control col-12" id="select-type">
                                    <?php $__currentLoopData = dataPhoto::TYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($row); ?>"><?php echo e(dataPhoto::TYPE_NAME[$row]); ?></option>
...
<?php $__env->startSection('validate'); ?>
    <?php echo JsValidator::formRequest('Modules\Admins\Http\Requests\Photo\CreateRequest','#form-create'); ?>
...
<?php echo $__env->make('admins::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/duycuong/Documents/Projects/duycuong/php/novel_cms/Modules/Admins/Resources/views/photos/create.blade.php ENDPATH**/ ?>