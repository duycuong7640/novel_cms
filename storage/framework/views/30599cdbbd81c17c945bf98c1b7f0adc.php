...
<section class="main-width">
    <div class="main-content">
        ...
        <div class="right-content">
            <?php echo $__env->make('pages::elements.sitebar-right', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</section>
...
<?php /**PATH /Users/duycuong/Documents/Projects/duycuong/php/novel_cms/Modules/Pages/Resources/views/layouts/master.blade.php ENDPATH**/ ?>