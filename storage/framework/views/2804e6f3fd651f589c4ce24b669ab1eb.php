                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Vị trí</label>
                                <input type="number" name="rank" class="form-control" placeholder=""/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control col-md-3">
                                    ...
                                    <?php $__currentLoopData = dataCategory::TYPE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($row); ?>"><?php echo e(dataCategory::TYPE_NAME[$row]); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Icon Fontawesome --> <a target="_blank" href="https://fontawesome.com/v6/search">Link</a></label>
                                <input type="text" name="fontawesome_icon" class="form-control" placeholder="<?php echo e('<i class="fa-solid fa-house"></i>'); ?>"/>
                            </div>
...
<?php $__env->startSection('validate'); ?>
    <?php echo JsValidator::formRequest('Modules\Admins\Http\Requests\Category\CreateRequest','#form-create'); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admins::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/duycuong/Documents/Projects/duycuong/php/novel_cms/Modules/Admins/Resources/views/categories/create.blade.php ENDPATH**/ ?>